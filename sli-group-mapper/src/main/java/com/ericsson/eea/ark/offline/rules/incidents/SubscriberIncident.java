 ...
 */
@NoArgsConstructor
public class SubscriberIncident {

   private static final Logger log = LoggerFactory.getLogger(SubscriberIncident.class.getName());
   ...
   public SubscriberIncident(SubscriberIncident other) {
